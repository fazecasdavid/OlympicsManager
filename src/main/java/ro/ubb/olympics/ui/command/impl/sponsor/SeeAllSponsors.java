...
/**
 * Command used to see all sponsors.
 */
public class SeeAllSponsors extends Command {
     ...
     */
    public SeeAllSponsors(final String key, final String description, final Controller controller, final Scanner scanner) {
