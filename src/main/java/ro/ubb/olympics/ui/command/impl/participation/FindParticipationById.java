...
/**
 * Command used to find a participation by ID.
 */
public class FindParticipationById extends Command {
     ...
     */
    public FindParticipationById(final String key, final String description, final Controller controller, final Scanner scanner) {
    ...
    public void execute() {
        ...
        System.out.println(
            controller
                ...
                .orElseThrow(() -> new RuntimeException("There is no participation with the given ID."))
        );
    }
