...
/**
 * Command used to see all competitions.
 */
public class SeeAllCompetitions extends Command {
     ...
     */
    public SeeAllCompetitions(final String key, final String description, final Controller controller, final Scanner scanner) {
