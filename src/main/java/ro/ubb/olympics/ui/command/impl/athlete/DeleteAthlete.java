...
/**
 * Command used to delete an athlete.
 */
public class DeleteAthlete extends Command {
     ...
     */
    public DeleteAthlete(final String key, final String description, final Controller controller, final Scanner scanner) {
    ...
    public void execute() {
        ...
        controller
            .deleteAthlete(id)
            .orElseThrow(() -> new RuntimeException("The athlete could not be deleted"))
        ;
    }
