...
/**
 * Command used to add sponsorship.
 */
public class AddSponsorship extends Command {
     ...
     */
    public AddSponsorship(final String key, final String description, final Controller controller, final Scanner scanner) {
    ...
    public void execute() {
        ...
        controller.addSponsorship(id, competitionId, sponsorId, moneyContribution)
            .ifPresent(unused -> {
                    throw new RuntimeException("The sponsorship could not be added.");
                }
            );
    }
}
