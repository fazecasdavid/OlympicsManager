...
/**
 * Command used to find a competition by ID.
 */
public class FindCompetitionById extends Command {
     ...
     */
    public FindCompetitionById(final String key, final String description, final Controller controller, final Scanner scanner) {
