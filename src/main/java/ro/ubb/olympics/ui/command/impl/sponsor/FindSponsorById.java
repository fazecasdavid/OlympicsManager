...
/**
 * Command used to find a sponsor by its ID.
 */
public class FindSponsorById extends Command {
     ...
     */
    public FindSponsorById(final String key, final String description, final Controller controller, final Scanner scanner) {
