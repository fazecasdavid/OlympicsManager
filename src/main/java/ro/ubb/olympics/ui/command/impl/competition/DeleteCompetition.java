...
/**
 * Command used to delete a competition.
 */
public class DeleteCompetition extends Command {
     ...
     */
    public DeleteCompetition(final String key, final String description, final Controller controller, final Scanner scanner) {
    ...
    public void execute() {
        ...
        controller
            ...
            .orElseThrow(() -> new RuntimeException("The competition could not be deleted"));
    }
