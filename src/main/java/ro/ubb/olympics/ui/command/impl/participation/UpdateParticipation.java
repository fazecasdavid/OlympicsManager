...
/**
 * Command used to update a participation.
 */
public class UpdateParticipation extends Command {
     ...
     */
    public UpdateParticipation(final String key, final String description, final Controller controller, final Scanner scanner) {
    ...
    public void execute() {
        ...
        controller.updateParticipation(id, athleteId, competitionId, rank)
            .orElseThrow(() ->
                new RuntimeException("The participation could not be updated")
            );
    }
